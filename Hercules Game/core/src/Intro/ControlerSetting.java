...
public class ControlerSetting implements Screen {
    ...
    void Buttons() {
        ...
        up.setPosition(Gdx.graphics.getWidth() / 2 - 500, Gdx.graphics.getHeight() / 2 + 260);
        ...
        save.setPosition(Gdx.graphics.getWidth() / 2 + 600, Gdx.graphics.getHeight() / 2);
        ...
        back.setPosition(Gdx.graphics.getWidth() / 2 + 600, Gdx.graphics.getHeight() / 2 - 100);
