...
public class HUD3 implements Disposable{
    ...
    public HUD3(PlayScreen screen) {
        ...
        table.add(image).padTop(stage.getHeight()-190f).padLeft(200f);
        table.add(image3).padTop(stage.getHeight()-190f).padRight(500f);
        table.add(scoreText).expandX().padTop(stage.getHeight()-200f).padLeft(-100);
        table.add(image4).padTop(stage.getHeight()-190f).padLeft(300f);
        table.add(image2).padTop(stage.getHeight()-190f).padLeft(0);
        table.add(scoreLabel).expandX().padTop(stage.getHeight()-80).padLeft(-2110);

        table.setBackground(skin.getDrawable("dialogDim"));
        table.setSize(stage.getWidth(), 150);
        table.setPosition(0, stage.getHeight()-200);
